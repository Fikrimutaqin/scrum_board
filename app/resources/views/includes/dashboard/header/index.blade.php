...
<!-- Slick CSS-->
<link href="{{ URL::to('assets/slick-1.8.1/slick-1.8.1/slick/slick.css') }}" rel="stylesheet" />
<link href="{{ URL::to('assets/slick-1.8.1/slick-1.8.1/slick/slick-theme.css') }}" rel="stylesheet" />
...
<link
    ...
    rel="stylesheet">
<!-- Style Custom CSS-->
<link rel="stylesheet" href="{{ URL::to('assets/dashboard/css/style.css') }}" />
